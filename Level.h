...
struct Object
{
	...
	map<std::string, std::string> properties;//создаём ассоциатиный массив. ключ - строковый тип, значение - строковый
...
struct Layer//слои
{
	...
	vector<sf::Sprite> tiles;//закидываем в вектор тайлы
};
